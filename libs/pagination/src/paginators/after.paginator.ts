  ...
  implements Paginator<Entity>
{
  ...
  private appendWhereConditions(queryBuilder: SelectQueryBuilder<Entity>) {
    const cursor = JSON.parse(decode(this.query.before)) as Partial<Entity>
